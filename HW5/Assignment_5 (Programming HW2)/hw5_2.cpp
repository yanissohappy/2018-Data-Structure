...
void search_delete_array(int arr[100],int modified);
...
int main()
{
	...
	be_modified=atoi(str);

	search_delete_array(arr,be_modified);	
...
void search_delete_array(int arr[100],int modified)
{
	...
	{
		if(arr[i]==modified){
			arr[i]=arr[HowManyInArray(arr)-1];	
			arr[HowManyInArray(arr)-1]=-9999999;
